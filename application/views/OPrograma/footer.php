		...
		<div class="container">
			<div class="row text-center text-xs-center text-sm-left text-md-left">
				...
				<div class="col-xs-12 col-sm-3 col-md-3">
					<h5>O Programa</h5>
					<ul class="list-unstyled quick-links">
						<li><a href="apresentacao.php"><i class="fa fa-angle-double-right"></i>Apresentação</a></li>
						<li><a href="docentes.php"><i class="fa fa-angle-double-right"></i>Docentes</a></li>
						<li><a href="linhaDePesquisa.php"><i class="fa fa-angle-double-right"></i>Linhas de Pesquisas</a></li>
						<li><a href="bancoDeTeses.php"><i class="fa fa-angle-double-right"></i>Banco de Teses e Dissertações</a></li>
