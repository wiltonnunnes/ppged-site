		...
		<div class="container">
			<div class="row text-center text-xs-center text-sm-left text-md-left">
				...
				<div class="col-xs-12 col-sm-3 col-md-3">
					<h5>Cursos</h5>
					<ul class="list-unstyled quick-links">
						<li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Mestrado</a></li>
						<li><a href="http://lte.ce.ufrn.br/"><i class="fa fa-angle-double-right"></i>Doutorado</a></li>
						<li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Especialização</a></li>
					</ul>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-5">
					<ul class="list-unstyled list-inline social text-center">
						<li class="list-inline-item"><a href=""><img src="<?php echo base_url('img/logo_ufrn_white.png'); ?>" width="90"/></li>
						<li class="list-inline-item"><a href=""><img src="<?php echo base_url('img/capes_logo.png'); ?>" width="60"/></a></li>
						<li class="list-inline-item"><a href=""><img src="<?php echo base_url('img/Cnpq-logo.png'); ?>" width="100"/></a></li>
						<li class="list-inline-item"><a href=""><img src="<?php echo base_url('img/logoSigaa.png'); ?>" width="90"/></a></li>
						<li class="list-inline-item"><a href="" target="_blank"><img src="<?php echo base_url('img/logo_bczm.png'); ?>" width="60"/></a></li>
						<li class="list-inline-item"><a href="" target="_blank"><img src="<?php echo base_url('img/logo-revista.png'); ?>" width="110"/></a></li>
					</ul>
				</div>
				</hr>
			</div>	
