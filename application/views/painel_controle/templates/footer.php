			...
			<div class="row text-center text-xs-center text-sm-left text-md-left">
				...
				<div class="col-xs-12 col-sm-3 col-md-3">
					...
					<ul class="list-unstyled quick-links">
						...
						<li><a href="#"><i class="fa fa-angle-double-right"></i>Notícias</a></li>
				...
				<div class="col-xs-12 col-sm-3 col-md-3">
					<h5>O Programa</h5>
					<ul class="list-unstyled quick-links">
						<li><a href="../O Programa/apresentacao.php"><i class="fa fa-angle-double-right"></i>Apresentação</a></li>
						<li><a href="../O Programa/docentes.php"><i class="fa fa-angle-double-right"></i>Docentes</a></li>
						<li><a href="../O Programa/linhaDePesquisa.php"><i class="fa fa-angle-double-right"></i>Linhas de Pesquisas</a></li>
						<li><a href="../O Programa/bancoDeTeses.php"><i class="fa fa-angle-double-right"></i>Banco de Teses e Dissertações</a></li>
						<li><a href="#"><i class="fa fa-angle-double-right"></i>Publicações</a></li>
						<li><a href="#"><i class="fa fa-angle-double-right"></i>Cursos</a></li>
					</ul>
				</div>
				<div class="col-xs-12 col-sm-3 col-md-3">
					<h5>Cursos</h5>
					<ul class="list-unstyled quick-links">
						<li><a href="#"><i class="fa fa-angle-double-right"></i>Mestrado</a></li>
						<li><a href="#"><i class="fa fa-angle-double-right"></i>Doutorado</a></li>
						<li><a href="#"><i class="fa fa-angle-double-right"></i>Especialização</a></li>
					</ul>
				</div>
			</div>
			<div class="row">
