...
class Professores extends MY_Controller {
	...
	public function listar() {
		...
		$data['professores'] = isset($keyword) ? $this->professores_model->search($keyword, $config['per_page'], $page * $config['per_page']) : $this->professores_model->get(array(), $config['per_page'], $page * $config['per_page']);
